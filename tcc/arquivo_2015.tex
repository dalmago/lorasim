...
\author{Matheus Dal Mago}   %%%%% AUTOR DO TRABALHO
...
\email{matheusdalmago@gmail.com}   %%%% E-MAIL PARA CATALOGRAFICA (COPYRIGHT) - OBRIGATORIO
\endereco{Avenida Rodolfo Behr, n. 320} %%%% TELEFONE PARA CATALOGRAFICA (COPYRIGHT) (CAMPO OPICIONAL -- CASO NAO POSSUA OU NAO QUEIRA DIVULGAR COMENTE A LINHA)
\fone{55 99669-6825}   %%%% TELEFONE PARA CATALOGRAFICA (COPYRIGHT) FORMATO {11 2222 3333} (CAMPO OPICIONAL -- CASO NAO POSSUA OU NAO QUEIRA DIVULGAR COMENTE A LINHA)
...
% % % %  TITULO DO TRABALHO
\titulo{TÉCNICAS DE INTELIGÊNCIA ARTIFICIAL APLICADAS À CONFIGURAÇÃO DE PARÂMETROS DE UMA REDE LORA} %% NAO EH NECESSARIO CAPITALIZAR
% % % %  TITULO DO TRABALHO EM INGLES
\englishtitle{Artificial Intelligence Techniques Applied to Parameters Configuration of a LoRa Network}  %% NAO EH NECESSARIO CAPITALIZAR
...
% % % DATA DA DEFESA 
\data{15}{12}{2017} %% FORMATO {DD}{MM}{AAAA}
